...
mod tests {
    use super::{
        ...
        merge_paired_peers, merge_tailscale_heartbeat, peer_socket_addr, queue_pool_frame,
        race_connect_and_handshake, secure, source_matches_mode, store_peer_cache, AckExpectation,
