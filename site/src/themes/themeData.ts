...
const THEME_META: ThemeMeta[] = [
  {
    ...
    packageFile: 'canvas-atelier.tailsync-theme',
    icon: Feather,
    nameZh: '纸上工坊',
    tagline: '暖纸、活字与留白。',
    description:
  ...
  },
  {
    ...
    packageFile: 'flux-circuit.tailsync-theme',
    icon: CircuitBoard,
    nameZh: '流电矩阵',
    tagline: '信号干净，走线笔直。',
    description:
  ...
  },
  {
    ...
    packageFile: 'ledger-archive.tailsync-theme',
    icon: BookOpen,
    nameZh: '绿档账房',
    tagline: '每一笔，都有据可查。',
    description:
  ...
  },
  {
    ...
    packageFile: 'aura-bloom.tailsync-theme',
    icon: Flower2,
    nameZh: '绮光绽放',
    tagline: '柔软，但不失分寸。',
    description:
  ...
  },
  {
    ...
    packageFile: 'mono-strict.tailsync-theme',
    icon: Terminal,
    nameZh: '白纸黑律',
    tagline: '零装饰，零妥协。',
    description:
