...
import { themeV2CssPairs } from "./themeV2Css";
...
describe("themeV2CssPairs", () => {
  it("maps every semantic V2 colour and structural token to the CSS contract", () => {
    ...
    expect(css).toMatchObject({ "--brand": "a", "--brand-hover": "b", "--brand-soft": "c", "--brand-text": "d", "--bg-window": "e", "--bg-card": "f", "--bg-input": "g", "--bg-hover": "h", "--bg-active": "i", "--bg-raised": "j", "--bg-toast": "k", "--text-primary": "l", "--text-secondary": "m", "--text-tertiary": "n", "--text-toast": "o", "--border": "p", "--border-strong": "q", "--divider": "r", "--green": "s", "--green-soft": "t", "--orange": "u", "--orange-soft": "v", "--purple": "w", "--purple-soft": "x", "--font-ui": "UI, sans", "--font-display": "Display", "--font-content": "Reading", "--search-font-family": "var(--font-display)", "--shadow-md": "0 2px 9px rgba(0, 0, 0, 0.3)", "--art-fast": "100ms", "--art-slow": "200ms", "--art-spring": "linear" });
  });
